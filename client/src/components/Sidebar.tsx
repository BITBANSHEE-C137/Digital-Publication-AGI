    ...
    <div className="h-full flex flex-col py-8 px-6 bg-background border-r border-border/40">
      <div className="mb-10">
        <Link href="/" className="block">
          <h1 className="font-display text-2xl font-bold leading-tight tracking-tight text-primary hover:text-accent transition-colors">
            When We <br />
            Outsourced <br />
            Thinking
          </h1>
      ...
      <div className="mt-8 pt-6 border-t border-border/60 text-xs text-muted-foreground font-sans">
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-md border-b border-border/40 z-40 flex items-center justify-between px-4">
        <Link href="/">
           <span className="font-display font-bold text-lg truncate">Outsourced Thinking</span>
        </Link>
        
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetTrigger asChild>
            <button className="p-2 -mr-2 text-primary hover:bg-secondary rounded-md transition-colors">
