...
import { ChevronDown, BookOpen, Home, Headphones, Search } from "lucide-react";
...
export function FloatingNav({ onOpenGlossary, onListenClick, onSearchClick }: FloatingNavProps) {
